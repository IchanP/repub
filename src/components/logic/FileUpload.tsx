...
const FileUpload = () => {
  ...
  return (
    <div className="w-full">
      <div className="absolute w-3/4 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 dark:bg-darkSecondary p-2 rounded-md">
        <label htmlFor="epub-file">
          ...
          bg-gray-50 focus:outline-none dark:bg-darkPrimary dark:text-white dark:border-gray-600 dark:placeholder-gray-400 py-1 pl-1"
            id="epub-file"
            type="file"
            accept=".epub"
